...
import minion_device_pb2 as minion__device__pb2
...
class MinionDeviceServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.change_settings = channel.unary_unary(
        ...
        request_serializer=minion__device__pb2.ChangeSettingsRequest.SerializeToString,
        response_deserializer=minion__device__pb2.ChangeSettingsResponse.FromString,
        )
    self.get_settings = channel.unary_unary(
        '/ont.rpc.minion_device.MinionDeviceService/get_settings',
        request_serializer=minion__device__pb2.GetSettingsRequest.SerializeToString,
        response_deserializer=minion__device__pb2.GetSettingsResponse.FromString,
        )
...
def add_MinionDeviceServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'change_settings': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=minion__device__pb2.ChangeSettingsRequest.FromString,
          response_serializer=minion__device__pb2.ChangeSettingsResponse.SerializeToString,
      ),
      'get_settings': grpc.unary_unary_rpc_method_handler(
          servicer.get_settings,
          request_deserializer=minion__device__pb2.GetSettingsRequest.FromString,
          response_serializer=minion__device__pb2.GetSettingsResponse.SerializeToString,
      ),
  }
