...
class InstanceServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.get_version_info = channel.unary_unary(
        ...
        request_serializer=instance__pb2.GetVersionInfoRequest.SerializeToString,
        response_deserializer=instance__pb2.GetVersionInfoResponse.FromString,
        )
    self.get_output_directories = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/get_output_directories',
        request_serializer=instance__pb2.GetOutputDirectoriesRequest.SerializeToString,
        response_deserializer=instance__pb2.OutputDirectories.FromString,
        )
    self.get_default_output_directories = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/get_default_output_directories',
        request_serializer=instance__pb2.GetDefaultOutputDirectoriesRequest.SerializeToString,
        response_deserializer=instance__pb2.OutputDirectories.FromString,
        )
    self.set_output_directory = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/set_output_directory',
        request_serializer=instance__pb2.SetOutputDirectoryRequest.SerializeToString,
        response_deserializer=instance__pb2.SetOutputDirectoryResponse.FromString,
        )
    self.set_reads_directory = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/set_reads_directory',
        request_serializer=instance__pb2.SetReadsDirectoryRequest.SerializeToString,
        response_deserializer=instance__pb2.SetReadsDirectoryResponse.FromString,
        )
    self.get_disk_space_info = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/get_disk_space_info',
        request_serializer=instance__pb2.GetDiskSpaceInfoRequest.SerializeToString,
        response_deserializer=instance__pb2.GetDiskSpaceInfoResponse.FromString,
        )
    self.get_machine_id = channel.unary_unary(
        '/ont.rpc.instance.InstanceService/get_machine_id',
        request_serializer=instance__pb2.GetMachineIdRequest.SerializeToString,
        response_deserializer=instance__pb2.GetMachineIdResponse.FromString,
        )
...
def add_InstanceServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'get_version_info': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=instance__pb2.GetVersionInfoRequest.FromString,
          response_serializer=instance__pb2.GetVersionInfoResponse.SerializeToString,
      ),
      'get_output_directories': grpc.unary_unary_rpc_method_handler(
          servicer.get_output_directories,
          request_deserializer=instance__pb2.GetOutputDirectoriesRequest.FromString,
          response_serializer=instance__pb2.OutputDirectories.SerializeToString,
      ),
      'get_default_output_directories': grpc.unary_unary_rpc_method_handler(
          servicer.get_default_output_directories,
          request_deserializer=instance__pb2.GetDefaultOutputDirectoriesRequest.FromString,
          response_serializer=instance__pb2.OutputDirectories.SerializeToString,
      ),
      'set_output_directory': grpc.unary_unary_rpc_method_handler(
          servicer.set_output_directory,
          request_deserializer=instance__pb2.SetOutputDirectoryRequest.FromString,
          response_serializer=instance__pb2.SetOutputDirectoryResponse.SerializeToString,
      ),
      'set_reads_directory': grpc.unary_unary_rpc_method_handler(
          servicer.set_reads_directory,
          request_deserializer=instance__pb2.SetReadsDirectoryRequest.FromString,
          response_serializer=instance__pb2.SetReadsDirectoryResponse.SerializeToString,
      ),
      'get_disk_space_info': grpc.unary_unary_rpc_method_handler(
          servicer.get_disk_space_info,
          request_deserializer=instance__pb2.GetDiskSpaceInfoRequest.FromString,
          response_serializer=instance__pb2.GetDiskSpaceInfoResponse.SerializeToString,
      ),
      'get_machine_id': grpc.unary_unary_rpc_method_handler(
          servicer.get_machine_id,
          request_deserializer=instance__pb2.GetMachineIdRequest.FromString,
          response_serializer=instance__pb2.GetMachineIdResponse.SerializeToString,
      ),
  }
