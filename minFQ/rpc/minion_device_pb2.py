...
_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY.has_options = True
_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_CHANGESETTINGSREQUEST.fields_by_name['settings'].has_options = True
_CHANGESETTINGSREQUEST.fields_by_name['settings']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\220\265\030\001'))
_GETSETTINGSRESPONSE.fields_by_name['settings'].has_options = True
_GETSETTINGSRESPONSE.fields_by_name['settings']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\220\265\030\001'))
