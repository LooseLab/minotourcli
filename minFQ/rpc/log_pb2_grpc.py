...
class LogServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.get_user_messages = channel.unary_stream(
        ...
        request_serializer=log__pb2.GetUserMessagesRequest.SerializeToString,
        response_deserializer=log__pb2.UserMessage.FromString,
        )
    self.send_user_message = channel.unary_unary(
        '/ont.rpc.log.LogService/send_user_message',
        request_serializer=log__pb2.SendUserMessageRequest.SerializeToString,
        response_deserializer=log__pb2.SendUserMessageResponse.FromString,
        )
    self.send_ping = channel.unary_unary(
        '/ont.rpc.log.LogService/send_ping',
        request_serializer=log__pb2.SendPingRequest.SerializeToString,
        response_deserializer=log__pb2.SendPingResponse.FromString,
        )
...
def add_LogServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'get_user_messages': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=log__pb2.GetUserMessagesRequest.FromString,
          response_serializer=log__pb2.UserMessage.SerializeToString,
      ),
      'send_user_message': grpc.unary_unary_rpc_method_handler(
          servicer.send_user_message,
          request_deserializer=log__pb2.SendUserMessageRequest.FromString,
          response_serializer=log__pb2.SendUserMessageResponse.SerializeToString,
      ),
      'send_ping': grpc.unary_unary_rpc_method_handler(
          servicer.send_ping,
          request_deserializer=log__pb2.SendPingRequest.FromString,
          response_serializer=log__pb2.SendPingResponse.SerializeToString,
      ),
  }
