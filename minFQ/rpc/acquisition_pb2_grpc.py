...
class AcquisitionServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.start = channel.unary_unary(
        ...
        request_serializer=acquisition__pb2.StartRequest.SerializeToString,
        response_deserializer=acquisition__pb2.StartResponse.FromString,
        )
    self.stop = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/stop',
        request_serializer=acquisition__pb2.StopRequest.SerializeToString,
        response_deserializer=acquisition__pb2.StopResponse.FromString,
        )
    self.watch_for_status_change = channel.stream_stream(
        '/ont.rpc.acquisition.AcquisitionService/watch_for_status_change',
        request_serializer=acquisition__pb2.WatchForStatusChangeRequest.SerializeToString,
        response_deserializer=acquisition__pb2.WatchForStatusChangeResponse.FromString,
        )
    self.watch_current_acquisition_run = channel.unary_stream(
        ...
        request_serializer=acquisition__pb2.WatchCurrentAcquisitionRunRequest.SerializeToString,
        response_deserializer=acquisition__pb2.AcquisitionRunInfo.FromString,
        )
    self.current_status = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/current_status',
        request_serializer=acquisition__pb2.CurrentStatusRequest.SerializeToString,
        response_deserializer=acquisition__pb2.CurrentStatusResponse.FromString,
        )
    self.get_progress = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/get_progress',
        request_serializer=acquisition__pb2.GetProgressRequest.SerializeToString,
        response_deserializer=acquisition__pb2.GetProgressResponse.FromString,
        )
    self.get_acquisition_info = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/get_acquisition_info',
        request_serializer=acquisition__pb2.GetAcquisitionRunInfoRequest.SerializeToString,
        response_deserializer=acquisition__pb2.AcquisitionRunInfo.FromString,
        )
    self.list_acquisition_runs = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/list_acquisition_runs',
        request_serializer=acquisition__pb2.ListAcquisitionRunsRequest.SerializeToString,
        response_deserializer=acquisition__pb2.ListAcquisitionRunsResponse.FromString,
        )
    self.get_current_acquisition_run = channel.unary_unary(
        '/ont.rpc.acquisition.AcquisitionService/get_current_acquisition_run',
        request_serializer=acquisition__pb2.GetCurrentAcquisitionRunRequest.SerializeToString,
        response_deserializer=acquisition__pb2.AcquisitionRunInfo.FromString,
        )
...
def add_AcquisitionServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'start': grpc.unary_unary_rpc_method_handler(
          servicer.start,
          request_deserializer=acquisition__pb2.StartRequest.FromString,
          response_serializer=acquisition__pb2.StartResponse.SerializeToString,
      ),
      'stop': grpc.unary_unary_rpc_method_handler(
          servicer.stop,
          request_deserializer=acquisition__pb2.StopRequest.FromString,
          response_serializer=acquisition__pb2.StopResponse.SerializeToString,
      ),
      'watch_for_status_change': grpc.stream_stream_rpc_method_handler(
          servicer.watch_for_status_change,
          request_deserializer=acquisition__pb2.WatchForStatusChangeRequest.FromString,
          response_serializer=acquisition__pb2.WatchForStatusChangeResponse.SerializeToString,
      ),
      'watch_current_acquisition_run': grpc.unary_stream_rpc_method_handler(
          servicer.watch_current_acquisition_run,
          request_deserializer=acquisition__pb2.WatchCurrentAcquisitionRunRequest.FromString,
          response_serializer=acquisition__pb2.AcquisitionRunInfo.SerializeToString,
      ),
      'current_status': grpc.unary_unary_rpc_method_handler(
          servicer.current_status,
          request_deserializer=acquisition__pb2.CurrentStatusRequest.FromString,
          response_serializer=acquisition__pb2.CurrentStatusResponse.SerializeToString,
      ),
      'get_progress': grpc.unary_unary_rpc_method_handler(
          servicer.get_progress,
          request_deserializer=acquisition__pb2.GetProgressRequest.FromString,
          response_serializer=acquisition__pb2.GetProgressResponse.SerializeToString,
      ),
      'get_acquisition_info': grpc.unary_unary_rpc_method_handler(
          servicer.get_acquisition_info,
          request_deserializer=acquisition__pb2.GetAcquisitionRunInfoRequest.FromString,
          response_serializer=acquisition__pb2.AcquisitionRunInfo.SerializeToString,
      ),
      'list_acquisition_runs': grpc.unary_unary_rpc_method_handler(
          servicer.list_acquisition_runs,
          request_deserializer=acquisition__pb2.ListAcquisitionRunsRequest.FromString,
          response_serializer=acquisition__pb2.ListAcquisitionRunsResponse.SerializeToString,
      ),
      'get_current_acquisition_run': grpc.unary_unary_rpc_method_handler(
          servicer.get_current_acquisition_run,
          request_deserializer=acquisition__pb2.GetCurrentAcquisitionRunRequest.FromString,
          response_serializer=acquisition__pb2.AcquisitionRunInfo.SerializeToString,
      ),
  }
