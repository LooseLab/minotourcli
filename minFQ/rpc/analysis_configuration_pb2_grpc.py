...
import analysis_configuration_pb2 as analysis__configuration__pb2
...
class AnalysisConfigurationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.get_analysis_configuration = channel.unary_unary(
        ...
        request_serializer=analysis__configuration__pb2.GetAnalysisConfigurationRequest.SerializeToString,
        response_deserializer=analysis__configuration__pb2.AnalysisConfiguration.FromString,
        )
    self.set_analysis_configuration = channel.unary_unary(
        ...
        request_serializer=analysis__configuration__pb2.AnalysisConfiguration.SerializeToString,
        response_deserializer=analysis__configuration__pb2.SetAnalysisConfigurationResponse.FromString,
        )
    self.set_analysis_enabled_state = channel.unary_unary(
        ...
        request_serializer=analysis__configuration__pb2.SetAnalysisEnabledStateRequest.SerializeToString,
        response_deserializer=analysis__configuration__pb2.SetAnalysisEnabledStateResponse.FromString,
        )
    self.get_channel_states_desc = channel.unary_unary(
        ...
        request_serializer=analysis__configuration__pb2.GetChannelStatesDescRequest.SerializeToString,
        response_deserializer=analysis__configuration__pb2.GetChannelStatesDescResponse.FromString,
        )
    self.get_summary = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/get_summary',
        request_serializer=analysis__configuration__pb2.GetSummaryRequest.SerializeToString,
        response_deserializer=analysis__configuration__pb2.GetSummaryResponse.FromString,
        )
...
class AnalysisConfigurationServiceServicer(object):
  ...
  def set_analysis_configuration(self, request, context):
    ...
    >>>
    >>> analysis_conf_pb = rpc.analysis_configuration_service.AnalysisConfiguration()
...
def add_AnalysisConfigurationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'get_analysis_configuration': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=analysis__configuration__pb2.GetAnalysisConfigurationRequest.FromString,
          response_serializer=analysis__configuration__pb2.AnalysisConfiguration.SerializeToString,
      ),
      'set_analysis_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.set_analysis_configuration,
          request_deserializer=analysis__configuration__pb2.AnalysisConfiguration.FromString,
          response_serializer=analysis__configuration__pb2.SetAnalysisConfigurationResponse.SerializeToString,
      ),
      'set_analysis_enabled_state': grpc.unary_unary_rpc_method_handler(
          servicer.set_analysis_enabled_state,
          request_deserializer=analysis__configuration__pb2.SetAnalysisEnabledStateRequest.FromString,
          response_serializer=analysis__configuration__pb2.SetAnalysisEnabledStateResponse.SerializeToString,
      ),
      'get_channel_states_desc': grpc.unary_unary_rpc_method_handler(
          servicer.get_channel_states_desc,
          request_deserializer=analysis__configuration__pb2.GetChannelStatesDescRequest.FromString,
          response_serializer=analysis__configuration__pb2.GetChannelStatesDescResponse.SerializeToString,
      ),
      'get_summary': grpc.unary_unary_rpc_method_handler(
          servicer.get_summary,
          request_deserializer=analysis__configuration__pb2.GetSummaryRequest.FromString,
          response_serializer=analysis__configuration__pb2.GetSummaryResponse.SerializeToString,
      ),
  }
