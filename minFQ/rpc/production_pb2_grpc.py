...
import production_pb2 as production__pb2
...
class ProductionServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.write_flowcell_data = channel.unary_unary(
        ...
        request_serializer=production__pb2.WriteFlowcellDataRequest.SerializeToString,
        response_deserializer=production__pb2.WriteFlowcellDataResponse.FromString,
        )
    self.write_flowcell_id = channel.unary_unary(
        '/ont.rpc.production.ProductionService/write_flowcell_id',
        request_serializer=production__pb2.WriteFlowcellIdRequest.SerializeToString,
        response_deserializer=production__pb2.WriteFlowcellIdResponse.FromString,
        )
    self.write_wells_per_channel = channel.unary_unary(
        '/ont.rpc.production.ProductionService/write_wells_per_channel',
        request_serializer=production__pb2.WriteWellsPerChannelRequest.SerializeToString,
        response_deserializer=production__pb2.WriteWellsPerChannelResponse.FromString,
        )
    self.write_product_code = channel.unary_unary(
        '/ont.rpc.production.ProductionService/write_product_code',
        request_serializer=production__pb2.WriteProductCodeRequest.SerializeToString,
        response_deserializer=production__pb2.WriteProductCodeResponse.FromString,
        )
    self.write_temperature_offset = channel.unary_unary(
        '/ont.rpc.production.ProductionService/write_temperature_offset',
        request_serializer=production__pb2.WriteTemperatureOffsetRequest.SerializeToString,
        response_deserializer=production__pb2.WriteTemperatureOffsetResponse.FromString,
        )
...
def add_ProductionServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'write_flowcell_data': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=production__pb2.WriteFlowcellDataRequest.FromString,
          response_serializer=production__pb2.WriteFlowcellDataResponse.SerializeToString,
      ),
      'write_flowcell_id': grpc.unary_unary_rpc_method_handler(
          servicer.write_flowcell_id,
          request_deserializer=production__pb2.WriteFlowcellIdRequest.FromString,
          response_serializer=production__pb2.WriteFlowcellIdResponse.SerializeToString,
      ),
      'write_wells_per_channel': grpc.unary_unary_rpc_method_handler(
          servicer.write_wells_per_channel,
          request_deserializer=production__pb2.WriteWellsPerChannelRequest.FromString,
          response_serializer=production__pb2.WriteWellsPerChannelResponse.SerializeToString,
      ),
      'write_product_code': grpc.unary_unary_rpc_method_handler(
          servicer.write_product_code,
          request_deserializer=production__pb2.WriteProductCodeRequest.FromString,
          response_serializer=production__pb2.WriteProductCodeResponse.SerializeToString,
      ),
      'write_temperature_offset': grpc.unary_unary_rpc_method_handler(
          servicer.write_temperature_offset,
          request_deserializer=production__pb2.WriteTemperatureOffsetRequest.FromString,
          response_serializer=production__pb2.WriteTemperatureOffsetResponse.SerializeToString,
      ),
  }
