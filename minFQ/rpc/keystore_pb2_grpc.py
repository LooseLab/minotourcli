...
class KeyStoreServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.store = channel.unary_unary(
        ...
        request_serializer=keystore__pb2.StoreRequest.SerializeToString,
        response_deserializer=keystore__pb2.StoreResponse.FromString,
        )
    self.remove = channel.unary_unary(
        '/ont.rpc.keystore.KeyStoreService/remove',
        request_serializer=keystore__pb2.RemoveRequest.SerializeToString,
        response_deserializer=keystore__pb2.RemoveResponse.FromString,
        )
    self.get_one = channel.unary_unary(
        '/ont.rpc.keystore.KeyStoreService/get_one',
        request_serializer=keystore__pb2.GetOneRequest.SerializeToString,
        response_deserializer=keystore__pb2.GetOneResponse.FromString,
        )
    ...
    self.watch = channel.unary_stream(
        ...
        request_serializer=keystore__pb2.WatchRequest.SerializeToString,
        response_deserializer=keystore__pb2.WatchResponse.FromString,
        )
...
def add_KeyStoreServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'store': grpc.unary_unary_rpc_method_handler(
          servicer.store,
          request_deserializer=keystore__pb2.StoreRequest.FromString,
          response_serializer=keystore__pb2.StoreResponse.SerializeToString,
      ),
      'remove': grpc.unary_unary_rpc_method_handler(
          servicer.remove,
          request_deserializer=keystore__pb2.RemoveRequest.FromString,
          response_serializer=keystore__pb2.RemoveResponse.SerializeToString,
      ),
      'get_one': grpc.unary_unary_rpc_method_handler(
          servicer.get_one,
          request_deserializer=keystore__pb2.GetOneRequest.FromString,
          response_serializer=keystore__pb2.GetOneResponse.SerializeToString,
      ),
      ...
      'watch': grpc.unary_stream_rpc_method_handler(
          servicer.watch,
          request_deserializer=keystore__pb2.WatchRequest.FromString,
          response_serializer=keystore__pb2.WatchResponse.SerializeToString,
      ),
  }
