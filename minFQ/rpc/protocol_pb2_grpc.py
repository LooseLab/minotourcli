...
class ProtocolServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.start_protocol = channel.unary_unary(
        ...
        request_serializer=protocol__pb2.StartProtocolRequest.SerializeToString,
        response_deserializer=protocol__pb2.StartProtocolResponse.FromString,
        )
    self.stop_protocol = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/stop_protocol',
        request_serializer=protocol__pb2.StopProtocolRequest.SerializeToString,
        response_deserializer=protocol__pb2.StopProtocolResponse.FromString,
        )
    self.wait_for_finished = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/wait_for_finished',
        request_serializer=protocol__pb2.WaitForFinishedRequest.SerializeToString,
        response_deserializer=protocol__pb2.ProtocolRunInfo.FromString,
        )
    self.get_run_info = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/get_run_info',
        request_serializer=protocol__pb2.GetRunInfoRequest.SerializeToString,
        response_deserializer=protocol__pb2.ProtocolRunInfo.FromString,
        )
    self.list_protocol_runs = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/list_protocol_runs',
        request_serializer=protocol__pb2.ListProtocolRunsRequest.SerializeToString,
        response_deserializer=protocol__pb2.ListProtocolRunsResponse.FromString,
        )
    self.get_current_protocol_run = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/get_current_protocol_run',
        request_serializer=protocol__pb2.GetCurrentProtocolRunRequest.SerializeToString,
        response_deserializer=protocol__pb2.ProtocolRunInfo.FromString,
        )
    self.watch_current_protocol_run = channel.unary_stream(
        '/ont.rpc.protocol.ProtocolService/watch_current_protocol_run',
        request_serializer=protocol__pb2.WatchCurrentProtocolRunRequest.SerializeToString,
        response_deserializer=protocol__pb2.ProtocolRunInfo.FromString,
        )
    self.list_protocols = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/list_protocols',
        request_serializer=protocol__pb2.ListProtocolsRequest.SerializeToString,
        response_deserializer=protocol__pb2.ListProtocolsResponse.FromString,
        )
    self.get_context_info = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/get_context_info',
        request_serializer=protocol__pb2.GetContextInfoRequest.SerializeToString,
        response_deserializer=protocol__pb2.GetContextInfoResponse.FromString,
        )
    self.set_context_info = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/set_context_info',
        request_serializer=protocol__pb2.SetContextInfoRequest.SerializeToString,
        response_deserializer=protocol__pb2.SetContextInfoResponse.FromString,
        )
    self.get_sample_id = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/get_sample_id',
        request_serializer=protocol__pb2.GetSampleIdRequest.SerializeToString,
        response_deserializer=protocol__pb2.GetSampleIdResponse.FromString,
        )
    self.set_sample_id = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/set_sample_id',
        request_serializer=protocol__pb2.SetSampleIdRequest.SerializeToString,
        response_deserializer=protocol__pb2.SetSampleIdResponse.FromString,
        )
    self.get_protocol_purpose = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/get_protocol_purpose',
        request_serializer=protocol__pb2.GetProtocolPurposeRequest.SerializeToString,
        response_deserializer=protocol__pb2.GetProtocolPurposeResponse.FromString,
        )
    self.set_protocol_purpose = channel.unary_unary(
        '/ont.rpc.protocol.ProtocolService/set_protocol_purpose',
        request_serializer=protocol__pb2.SetProtocolPurposeRequest.SerializeToString,
        response_deserializer=protocol__pb2.SetProtocolPurposeResponse.FromString,
        )
...
def add_ProtocolServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'start_protocol': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protocol__pb2.StartProtocolRequest.FromString,
          response_serializer=protocol__pb2.StartProtocolResponse.SerializeToString,
      ),
      'stop_protocol': grpc.unary_unary_rpc_method_handler(
          servicer.stop_protocol,
          request_deserializer=protocol__pb2.StopProtocolRequest.FromString,
          response_serializer=protocol__pb2.StopProtocolResponse.SerializeToString,
      ),
      'wait_for_finished': grpc.unary_unary_rpc_method_handler(
          servicer.wait_for_finished,
          request_deserializer=protocol__pb2.WaitForFinishedRequest.FromString,
          response_serializer=protocol__pb2.ProtocolRunInfo.SerializeToString,
      ),
      'get_run_info': grpc.unary_unary_rpc_method_handler(
          servicer.get_run_info,
          request_deserializer=protocol__pb2.GetRunInfoRequest.FromString,
          response_serializer=protocol__pb2.ProtocolRunInfo.SerializeToString,
      ),
      'list_protocol_runs': grpc.unary_unary_rpc_method_handler(
          servicer.list_protocol_runs,
          request_deserializer=protocol__pb2.ListProtocolRunsRequest.FromString,
          response_serializer=protocol__pb2.ListProtocolRunsResponse.SerializeToString,
      ),
      'get_current_protocol_run': grpc.unary_unary_rpc_method_handler(
          servicer.get_current_protocol_run,
          request_deserializer=protocol__pb2.GetCurrentProtocolRunRequest.FromString,
          response_serializer=protocol__pb2.ProtocolRunInfo.SerializeToString,
      ),
      'watch_current_protocol_run': grpc.unary_stream_rpc_method_handler(
          servicer.watch_current_protocol_run,
          request_deserializer=protocol__pb2.WatchCurrentProtocolRunRequest.FromString,
          response_serializer=protocol__pb2.ProtocolRunInfo.SerializeToString,
      ),
      'list_protocols': grpc.unary_unary_rpc_method_handler(
          servicer.list_protocols,
          request_deserializer=protocol__pb2.ListProtocolsRequest.FromString,
          response_serializer=protocol__pb2.ListProtocolsResponse.SerializeToString,
      ),
      'get_context_info': grpc.unary_unary_rpc_method_handler(
          servicer.get_context_info,
          request_deserializer=protocol__pb2.GetContextInfoRequest.FromString,
          response_serializer=protocol__pb2.GetContextInfoResponse.SerializeToString,
      ),
      'set_context_info': grpc.unary_unary_rpc_method_handler(
          servicer.set_context_info,
          request_deserializer=protocol__pb2.SetContextInfoRequest.FromString,
          response_serializer=protocol__pb2.SetContextInfoResponse.SerializeToString,
      ),
      'get_sample_id': grpc.unary_unary_rpc_method_handler(
          servicer.get_sample_id,
          request_deserializer=protocol__pb2.GetSampleIdRequest.FromString,
          response_serializer=protocol__pb2.GetSampleIdResponse.SerializeToString,
      ),
      'set_sample_id': grpc.unary_unary_rpc_method_handler(
          servicer.set_sample_id,
          request_deserializer=protocol__pb2.SetSampleIdRequest.FromString,
          response_serializer=protocol__pb2.SetSampleIdResponse.SerializeToString,
      ),
      'get_protocol_purpose': grpc.unary_unary_rpc_method_handler(
          servicer.get_protocol_purpose,
          request_deserializer=protocol__pb2.GetProtocolPurposeRequest.FromString,
          response_serializer=protocol__pb2.GetProtocolPurposeResponse.SerializeToString,
      ),
      'set_protocol_purpose': grpc.unary_unary_rpc_method_handler(
          servicer.set_protocol_purpose,
          request_deserializer=protocol__pb2.SetProtocolPurposeRequest.FromString,
          response_serializer=protocol__pb2.SetProtocolPurposeResponse.SerializeToString,
      ),
  }
